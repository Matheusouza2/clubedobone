...
function calcular() {
    ...
    var dados = '{ "from": { "postal_code": "56000000", "address": "Endereço do remetente", "number": "1" }, "to": {"postal_code": "' + $("#cep").val() + '",  "address": "Endereço do destinatário", "number": "2" }, "package": {"weight": '+peso+',"width": '+largura+',"height": '+altura+',"length": '+comprimento+'} }';
    console.log(dados);
    $.ajax({
        type: 'POST',
